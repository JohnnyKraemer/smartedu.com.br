...
<head>
    ...
    <link rel="shortcut icon"
          href="<?php echo asset('assets/demo/default/media/img/logo/favicon.ico') ?>"/>
                    ...
                    <div class="m-stack m-stack--ver m-stack--general">
                        <div class="m-stack__item m-stack__item--middle m-brand__logo">
                            <a href="{{ url('/') }}" class="m-brand__logo-wrapper">
                                <img alt=""
                                     src="<?php echo asset('assets/demo/default/media/img/logo/logo_default_dark.png') ?>"/>
                            </a>
                        </div>
                        ...
                        <div class="m-stack__item m-topbar__nav-wrapper">
                                    ...
                                    <div class="m-dropdown__wrapper">
                                        ...
                                        <div class="m-dropdown__inner">
                                            <div class="m-dropdown__header m--align-center"
                                                 style="background: url(<?php echo asset('assets/app/media/img/misc/notification_bg.jpg') ?>); background-size: cover;">
							...
							<i class="flaticon-share"></i>
                                    ...
                                    <div class="m-dropdown__wrapper">
                                        ...
                                        <div class="m-dropdown__inner">
                                            <div class="m-dropdown__header m--align-center"
                                                 style="background: url(<?php echo asset('assets/app/media/img/misc/quick_actions_bg.jpg') ?>; background-size: cover;">
								<span class="m-dropdown__header-title">
									Quick Actions
								</span>
                                                <span class="m-dropdown__header-subtitle">
