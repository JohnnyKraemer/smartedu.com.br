...
<div class="m-portlet">
	...
	<!--begin::Form-->
	<form class="m-form m-form--fit m-form--label-align-right" id="form_edit" action="{{url('admin/user', [$object->id])}}" method="POST">
		...
		<div class="m-portlet__body">
			...
			<div class="form-group m-form__group row">
				...
				<div class="col-lg-6 col-md-9 col-sm-12">
					<input type="text" class="form-control m-input" name="email" id="email" placeholder="Seu e-mail" value="{{ old('email', $object->email)}}">
