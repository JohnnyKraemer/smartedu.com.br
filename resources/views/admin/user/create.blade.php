...
<div class="m-portlet">
	...
	<!--begin::Form-->
	<form class="m-form m-form--fit m-form--label-align-right" id="form_create" action="{{ url('/admin/user') }}" method="POST">
		{{ csrf_field() }}
		<div class="m-portlet__body">
			...
			<div class="form-group m-form__group row">
				...
				<div class="col-lg-6 col-md-9 col-sm-12">
					<input type="text" class="form-control m-input" name="name" id="name" value="{{ old('name')}}" placeholder="Seu e-mail">
				</div>
			</div>
			<div class="form-group m-form__group row">
				<label class="col-form-label col-lg-3 col-sm-12">E-mail *</label>
				<div class="col-lg-6 col-md-9 col-sm-12">
					<input type="text" class="form-control m-input" name="email" id="email" value="{{ old('email')}}" placeholder="Seu e-mail">
			...
			<div class="form-group m-form__group row">
				...
				<div class="col-lg-6 col-md-9 col-sm-12">
					<select class="form-control m-bootstrap-select m_selectpicker" name="position_id" id="position_id">
						<option value="">
							Selecione
						</option>
...
<div class="form-group m-form__group row">
	...
	<div class="col-lg-6 col-md-9 col-sm-12">
		<input type="password" class="form-control m-input" name="password" id="password" value="{{ old('password')}}" placeholder="Sua senha">
		<span class="m-form__help">
...
<div class="form-group m-form__group row">
	...
	<div class="col-lg-6 col-md-9 col-sm-12">
		<input type="password" class="form-control m-input" name="confirm_password" id="confirm_password" value="{{ old('confirm_password')}}"
	...
	<div class="m-form__actions m-form__actions">
		<div class="row">
			<div class="col-lg-9 ml-lg-auto">
				<button data-toggle="modal" data-target="#modal_cancel" type="reset" class="btn btn-secondary">	Cancel</button>
...
<script src="<?php echo asset('assets/demo/default/custom/components/forms/widgets/bootstrap-select.js') ?>" type="text/javascript"></script>
<script>
